...
export const apiGatewayProxyCreateRequest: APIGatewayProxyEvent = {
    body: 'body',
    resource: '/{proxy+}',
...
export const storedItems: Item[] = [
    ...
    {
        id: '082bcc7c-4d8c-4a8c-acda-df19461c09e8',
        title: 'Title 2',
        status: 'SUCCESS',
        createdAt: 1612137600001
    }
];
